...
#[Route('/gestionnaire/salary')]
final class SalaryController extends AbstractController
{
    #[Route('/list', name: 'app_salary_index', methods: ['GET'])]
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $base = $form->get('montantDeBase')->getData();
            $prime = $form->get('prime')->getData();
            $reductions = $form->get('reductions')->getData();

            $salary->setNetApayer(($base + $prime) - $reductions);
    ...
    #[Route('show/{id}', name: 'app_salary_show', methods: ['GET'])]
    ...
    #[Route('edit/{id}', name: 'app_salary_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('delete/{id}', name: 'app_salary_delete', methods: ['POST'])]
