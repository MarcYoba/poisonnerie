 ...
 */
final class Version20260917223059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, identification VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, contrat VARCHAR(255) NOT NULL, montant VARCHAR(255) NOT NULL, createt_at DATE NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_5D9F75A1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE salary (id INT AUTO_INCREMENT NOT NULL, mois VARCHAR(20) NOT NULL, annee DATE NOT NULL, prime DOUBLE PRECISION NOT NULL, reductions DOUBLE PRECISION NOT NULL, net_apayer DOUBLE PRECISION NOT NULL, montant_de_base DOUBLE PRECISION NOT NULL, paid_at DATE NOT NULL, statut VARCHAR(50) NOT NULL, employee_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_9413BB718C03F15C (employee_id), INDEX IDX_9413BB71A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
